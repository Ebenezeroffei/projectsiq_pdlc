    ...
    return (
        <section className={`text-white ${notoSans.className}`}>
            ...
            <p className="text-sm font-semibold uppercase text-zinc-400 mt-4 leading-6">
                Precision Domiabra Limited Company (PDLC) is your trusted source for quality new and used cars. We own every vehicle we sell — no middlemen, just great cars at great prices.
            </p>
        </section>
    )
}
